                ...
                <tr>
                  <td>
                    <div class="media">
                      <div class="d-flex">
                        <img
                          src="product_picture/<%=p.getProduct_image() %>" style="width: 100px;height: 100px;border-radius: 50%";
                          alt=""
                        />
                      </div>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
	...
	function OpenCheckOut()
	{
		...
		var options={
				"key":"rzp_test_Sl0ZmWAF5k4t0f",
				"amount":amount,
				"currency":"INR",
				"name":"Tops",
				"description":"Test",
				"callback_url":"http://localhost:8080/Project/index.jsp?uid=<%=u.getUid()%>",
				"prefill" : {
					"name" : "Harshil Suthar",
					"email" : "jrsharshil@gmail.com",
					"contact" : "8849608595"
				},
				"notes" : {
					"address" : "Ahmedabad"
