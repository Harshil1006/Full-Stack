	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(action.equalsIgnoreCase("sign up"))
		{
			...
			if(flag==false)
			{
				...
				String savepath = "C:\\eclipse folder\\Eclipse practice\\Project\\src\\main\\webapp\\profile_picture";
				...
				String savePath2 = "C:\\eclipse folder\\Eclipse practice\\Project\\src\\main\\webapp\\profile_picture";
			...
			else
			{
				if(u.getPassword().equals(request.getParameter("password")))
				{
					...
					if(u.getUsertype().equals("Buyer"))
					{
						...
						System.out.println("Total Cart : "+list1.size());
						session.setAttribute("cart_count", list1.size());
						System.out.println(session.getAttribute("cart_count"));
