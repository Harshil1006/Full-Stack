...
public class ProductController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(action.equalsIgnoreCase("add product"))
		{
			...
			p.setUid(u.getUid());
			String savepath = "C:\\eclipse folder\\Eclipse practice\\Project\\src\\main\\webapp\\product_picture";
			...
			String savePath2 = "C:\\eclipse folder\\Eclipse practice\\Project\\src\\main\\webapp\\product_picture";
